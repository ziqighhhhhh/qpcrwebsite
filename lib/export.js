...
function buildRows(exp) {
  ...
  for (const w of exp.wells) {
    for (const dye of dyes) {
      ...
      const call = comp['11 Intermediate Call'] !== undefined ? comp['11 Intermediate Call'] : (stQ ? stQ.call : '');
      const rawCq = comp['26 CT1'] !== undefined ? comp['26 CT1'] : (stQ && stQ.cq !== undefined ? stQ.cq : null);
      rows.push({
        Well: w.label,
        Position: w.id,
        Sample: w.sampleName || '',
...
module.exports = { toCSV, toJSON, toXLSX, buildRows, zipStore };